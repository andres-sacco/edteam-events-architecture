...
public class KafkaConsumerConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, ReservationTransactionDTO> consumerReservationTransactionConsumerFactory() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
        configProps.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        configProps.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, KafkaAvroDeserializer.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ReservationTransactionDTO> consumerListenerReservationTransactionConsumerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, ReservationTransactionDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerReservationTransactionConsumerFactory());
        return factory;
    }
}
